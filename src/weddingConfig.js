...
export const wedding = {
  groom: {
    ...
    father: '김영호',
    mother: '이정숙',
    account: { bank: '국민은행', number: '123456-78-901234', holder: '김민준' },
  },
  bride: {
    name: '이서연',
    short: '서연',
    ...
    father: '이상철',
    mother: '박미영',
    account: { bank: '신한은행', number: '110-234-567890', holder: '이서연' },
  },
  date: {
    iso: '2026-10-17T13:00:00+09:00',
    text: '2026년 10월 17일 토요일',
    time: '오후 1시',
    year: 2026,
    month: 10,
    day: 17,
  ...
  venue: {
    ...
    lat: 37.5012,
    lng: 127.0396,
    naverMap: 'https://map.naver.com/v5/search/그랜드컨벤션',
    kakaoMap: 'https://map.kakao.com/?q=그랜드컨벤션',
